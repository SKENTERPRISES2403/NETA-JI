...
namespace NetaJi.Prototype.Editor
{
    public static partial class PrototypeSceneBuilder
    {
        ...
        private static readonly string[] BuildScenes = { MenuScenePath, ScenePath, ChapterTwoScenePath, ChapterThreeScenePath, ChapterFourScenePath, ChapterFiveScenePath, ChapterSixScenePath, ChapterSevenScenePath, ChapterEightScenePath, ChapterNineScenePath, ChapterTenScenePath, ChapterElevenScenePath, ChapterTwelveScenePath, ChapterThirteenScenePath, ChapterFourteenScenePath, ChapterFifteenScenePath, ChapterSixteenScenePath, ChapterSeventeenScenePath, ChapterEighteenScenePath, ChapterNineteenScenePath, ChapterTwentyScenePath };
        ...
        public static void Build()
        {
            ...
            Debug.Log($"NETA JI menu and chapter scenes generated through {ChapterTwentyScenePath}");
        }
        ...
        private static void ConfigureProject()
        {
            ...
            PlayerSettings.bundleVersion = "0.21.0";
